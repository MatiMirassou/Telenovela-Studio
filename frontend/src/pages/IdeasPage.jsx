            ...
            <div className="form-grid">
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="Clickbait-worthy title"
                />
              </div>
              <div className="form-group">
                <label>Setting</label>
                <input
                  type="text"
                  value={customIdea.setting}
                  onChange={(e) => setCustomIdea({...customIdea, setting: e.target.value})}
              ...
              <div className="form-group full-width">
                <label>Logline</label>
                <textarea
                  value={customIdea.logline}
                  onChange={(e) => setCustomIdea({...customIdea, logline: e.target.value})}
                  placeholder="One-sentence premise"
                />
              </div>
              <div className="form-group full-width">
                <label>Hook</label>
                <textarea
                  value={customIdea.hook}
                  onChange={(e) => setCustomIdea({...customIdea, hook: e.target.value})}
                  placeholder="The twist that hooks viewers"
                />
              </div>
              <div className="form-group full-width">
                <label>Main Conflict</label>
                <textarea
                  value={customIdea.main_conflict}
                  onChange={(e) => setCustomIdea({...customIdea, main_conflict: e.target.value})}
                  placeholder="Central dramatic tension"
                />
              </div>
            </div>
            <button onClick={addCustomIdea} className="btn btn-primary">
              Add Idea
            </button>
          </div>
        )}
